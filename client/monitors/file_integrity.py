...
Computes SHA-256 hashes for critical Windows system files, stores a baseline
in baseline.json, and detects modifications, additions, and deletions between
successive checks.
"""
...
# Default critical Windows files to monitor
