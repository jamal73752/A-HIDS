...
from server.core.ai_engine import AIEngine           # noqa: E402
from server.core.alert_manager import AlertManager   # noqa: E402
from server.db.database import DatabaseManager, create_database  # noqa: E402
from server.reports.report_generator import ReportGenerator  # noqa: E402
from server.core.rule_engine import RuleEngine       # noqa: E402
...
def create_app(config: Optional[Dict[str, Any]] = None) -> Flask:
    ...
    if server_cfg.get("websocket_enabled", True):
        try:
            from server.infra.websocket_manager import WebSocketManager, create_socketio
    ...
    _security = None
    try:
        from server.infra.security import SecurityManager
        redis_url = (
            "redis://{}:{}/{}".format(
